(function() {
  ...
  describe('Exercises in Recursion in Recursion in Recursion in...', function() {
    ...
    describe('2. Arraysum', function() {

      it('should return a number', function() {
        expect(typeof(arraySum([1,[2,3],[[4]],5]))).to.equal('number');
      });

      it('should return sum of all elements in array', function() {
      ...
      it('should use recursion by calling self', function () {
        arraySum.proxyCallCount = 0;
        arraySum([1,[2,3],[[4]],5]);
        expect(arraySum.proxyCallCount).to.be.above(1);
      });
    ...
    describe('11. modulo', function() {
      ...
      it('should return the modulo for given dividend and divisor', function() {
      ...
      it('should use recursion by calling self', function () {
        modulo.proxyCallCount = 0;
        modulo(8,4);
        expect(modulo.proxyCallCount).to.be.above(1);
      });
    });
    ...
    describe('12. divide', function() {

      it('should return a number', function() {
        expect(typeof(divide(22,6))).to.equal('number');
        expect(typeof(divide(-28,3))).to.equal('number');
      });
      ...
      it('should return the divide for given dividend and divisor', function() {
        expect(divide(2, 0)).to.equal(0);
        expect(divide(17, 5)).to.equal(3);
        expect(divide(22, 6)).to.equal(3);
        expect(divide(-22, -6)).to.equal(3);
        expect(divide(-22, 6)).to.equal(-3);
      });
    });
    ...
    describe('25. Return nth Fibonacci', function() {
      ...
      // Does not work when recursive function uses memoised data
      // it('should use recursion by calling self', function () {
    ...
    describe('34. Alternate sign', function() {
      ...
      it('should return an array', function() {
        expect(Array.isArray(alternateSign([2,7,8,3,1,4]))).to.equal(true);
      });
